    ...
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print(dedent("""
                ...
                the head putting down, then jump through the 
                Weapon Armory door.
                """))
    ...
    def enter(self):
        ...
        if guess == code:
            print(dedent("""
                ...
                gas out. You grab the nutron bomb and run as fast as 
            ...
            print(dedent("""
                ...
                sickening melting sound as the mechanism is fuzed 
